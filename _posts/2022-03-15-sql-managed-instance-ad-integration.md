...
![sqlmi-table](sqlmi-table.png)

# Configure AD integration

Depending on which method of authentication you require, different configurations must be done.
...
![connect-aadpassword-1](connect-aadpassword-1.png)
...
![connect-aadpassword-2](connect-aadpassword-2.png)
...
[Azure AD Connect: Seamless Single Sign-On – quickstart | Microsoft Docs](https://docs.microsoft.com/en-us/azure/active-directory/hybrid/how-to-connect-sso-quick-start)
...
![connect-adintegrated-1](connect-adintegrated-1.png)

**Troubleshooting** \
If you’re having issues connecting, verify that your seamless SSO is properly configured.

You might also be missing the necessary Azure Active Directory Authentication Library on your system that’s connecting to the SQL MI. The [documentation](https://docs.microsoft.com/en-us/azure/azure-sql/database/authentication-aad-configure?tabs=azure-powershell#configure-your-client-computers) on how to get these files installed on your system is a bit weird as it says you need to install SSMS, but I’m sure there must be some other way to get them.
